...
`AUTH_SECRET` is auto-generated by the app spec (`generate_value: true`) — no manual step required, though you can override it in the App Platform console before deploying.
